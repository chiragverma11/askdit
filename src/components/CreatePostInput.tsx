...
const CreatePostInput: FC<CreatePostInputProps> = ({ session }) => {
  return (
    <div className="mx-auto flex h-16 w-full items-center rounded-xl border border-default/25 bg-emphasis transition">
