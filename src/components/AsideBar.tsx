...
const AsideBar: FC<AsideBarProps> = ({}) => {
  return (
    <div className="container fixed inset-x-0 bottom-0 flex h-[4.25rem] w-full items-center justify-center bg-emphasis/80 py-8 shadow-inner ring ring-zinc-300/50 backdrop-blur transition-colors dark:ring-0 sm:h-20 lg:inset-x-auto lg:bottom-4 lg:left-4 lg:top-16 lg:h-[calc(100vh-15%)] lg:w-[10%] lg:rounded-3xl">
